...
const AgCDPlaybookPublicPreview: React.FC = () => {
  ...
  const loadPrompts = () => {
    // Filter prompts to only show allowed scenarios for public preview
    const allPrompts = getAllPrompts();
    const filteredPrompts = allPrompts.filter(p =>
      allowedScenarioIds.includes(p.scenarioId || '') ||
      p.type === 'Orchestrator'
    );
